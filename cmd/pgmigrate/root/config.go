...
also a valid configuration.
    ...
    dump:
      ...
      schema_names:
        - public
        - another_schema
      # The file to which to write the dump, defaults to "-" (stdout) if this is
      # relative, it is treated as relative to wherever the "pgmigrate" command
      # is invoked, NOT as relative to this config file.
      out: "./schema.sql"
      ...
      # Lines to be written, in order, at the end of the generated schema.
      footer:
        - "-- here's a comment"
        - "-- and heres another comment that will be the last line in the file"
	`),
	GroupID:          "dev",
